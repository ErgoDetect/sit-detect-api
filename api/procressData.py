...
class processData:
    ...
    def get_blink_right(self):
        if (self.data['rightEye']['33'] is not None and self.data['rightEye']['133'] is not None and
            self.data['rightEye']['144'] is not None and self.data['rightEye']['153'] is not None and
            self.data['rightEye']['158'] is not None and self.data['rightEye']['160'] is not None
            ):
    ...
    def get_blink_left(self):
        if (self.data['leftEye']['263'] is not None and self.data['leftEye']['362'] is not None and
            self.data['leftEye']['373'] is not None and self.data['leftEye']['380'] is not None and
            self.data['leftEye']['385'] is not None and self.data['leftEye']['387'] is not None
            ):
    ...
    def get_diameter_left(self):
        if self.data['leftIris']['474'] is not None and self.data['leftIris']['476'] is not None:
